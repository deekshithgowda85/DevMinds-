    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3 items-end">
        ...
        <button
          ...
          disabled={loading}
          className="px-6 py-2 rounded-lg font-semibold text-white transition-all disabled:opacity-40 bg-linear-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 active:scale-[0.98]"
        >
          {loading ? (
                ...
                <div className="mb-3">
                  ...
                  <div className="flex items-end gap-1 mt-2 h-16">
                    {confHistory.slice(-15).map((val, i) => (
                      <div
                        key={i}
                        className="flex-1 bg-linear-to-t from-blue-600 to-cyan-400 rounded-t opacity-80 hover:opacity-100 transition-opacity"
