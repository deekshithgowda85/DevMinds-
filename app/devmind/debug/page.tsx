      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <button
            ...
            className="w-full py-3 rounded-lg font-semibold text-white transition-all disabled:opacity-40 disabled:cursor-not-allowed bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 active:scale-[0.98]"
          >
            {loading ? (
              ...
              <div className="bg-[#111] rounded-xl border border-[#222] p-5">
                ...
                <div className="mb-3">
                  ...
                  <div className="w-full bg-[#222] rounded-full h-2">
                    <div
                      className="h-2 rounded-full transition-all duration-700 bg-linear-to-r from-purple-500 to-cyan-500"
